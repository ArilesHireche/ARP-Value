...
def spot_import(): #Importing spots
    spot1 = pd.read_excel("/Users/hirecheariles/Documents/Cours/Master Finance/ARP/Data/spot_rates_98-24.xls", sheet_name="daily_spot_1", skiprows=1, index_col="Code")
    spot2 = pd.read_excel("/Users/hirecheariles/Documents/Cours/Master Finance/ARP/Data/spot_rates_98-24.xls", skiprows=1, sheet_name="daily_spot_2", index_col="Code")
...
def PPP_import():
    df_PPP = pd.read_csv("/Users/hirecheariles/Documents/Cours/Master Finance/ARP/Data/OECD1960PPP.csv", sep=",")
